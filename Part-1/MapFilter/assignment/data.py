...
no_of_groceries=0;
f_products= list(filter(lambda prod:prod['category'] =='fragrances',product_data['products']))
#print(len(f_products))
print(f_products[0]['title'])
print(f_products[1]['title'])
print(f_products[2]['title'])
print(f_products[3]['title'])
print(f_products[4]['title'])